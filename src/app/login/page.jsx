...
export default function LoginPage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (res.ok) {
        if (data.token) {
          login(data.token)
          toast.success(`¡Bienvenido de vuelta, ${data.user.nombre}!`)
  ...
  const isFormValid = () => {
    return form.email && form.password && validateEmail(form.email) && form.password.length >= 6
  }
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 text-center mb-8">
            ...
            >
              Accede a tu cuenta de hechicero
            </motion.p>
          </div>
